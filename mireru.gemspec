...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency("gtk3", "2.2.3")
  spec.add_runtime_dependency("gtksourceview3", "2.2.3")
  spec.add_runtime_dependency("clutter-gtk", "2.2.3")
  spec.add_runtime_dependency("clutter-gstreamer", "2.2.3")
  spec.add_runtime_dependency("poppler", "2.2.3")
  spec.add_runtime_dependency("rsvg2", "2.2.3")
